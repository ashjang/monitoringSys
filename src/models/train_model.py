...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../../SAMSUNG/jangjange/data/processed/')
    #parser.add_argument('--output_folder', default="models/")
    parser.add_argument('--output_folder', default="/../../SAMSUNG/jangjange/models/")
    ...
    # Create model
    if model_type == "FUSION":
        model = FUSION(use_pose, use_ir, use_rgb, use_depth, use_thermal, pretrained, fusion_scheme)
    else:
    ...
    if model_type == "FUSION":
        output_folder += "pretrained=" + str(pretrained) + \
                         "_use_IR=" + str(use_ir) + \
                         "_use_RGB=" + str(use_rgb) + \
                         "_use_DEPTH=" + str(use_depth) + \
                         "_use_THERMAL=" + str(use_thermal) + \
