...
DATA_PATH:="$(shell pwd)/data/raw/"
PROCESSED_DATA_PATH:="/media/eslab/SAMSUNG/jangjange/data/processed/"
DATASET_TYPE = "" # [SKELETON, RGB, IR, DEPTH, THERMAL]
COMPRESSION = ""
COMPRESSION_OPTS = 9
...
train: 
	...
	--mirror_skeleton=$(MIRROR_SKELETON) \
	--evaluate_test=$(EVALUATE_TEST) \
	--seed=$(SEED)

## Make confusion matrix from model
confusion_matrix:
...
## Make confusion matrix from cpkl file
confusion_matrix_cpkl:
	$(PYTHON_INTERPRETER) src/models/plot_confusion_matrix_cpkl.py \
	--model_folder=$(MODEL_FOLDER) \
	--cpkl_file=$(CPKL_FILE)
